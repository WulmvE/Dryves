...
<form name="quick_create_form" method="post" action="createRideConfirmed">
    <div id="quick_search" class="block_six white">		
        <h2>rit aanmaken</h2><br/><br/><br/><br/>
            <input class="input_location" name="create_start" type="text"  placeholder="${create_start}"/><br/>
            <input class="input_location" name="create_destination" type="text"  placeholder= "${create_end}"/><br/>
            <input class="input_date"  name="create_date" type="text"  placeholder="${create_date}" /><br/>
    </div>

    <div id="quick_create" class="block_six white">		
        <h2>details</h2><br/><br/><br/><br/>
        
            <input class="input_car" name="create_carid" type="text"  placeholder="${create_car}"/><br/>
