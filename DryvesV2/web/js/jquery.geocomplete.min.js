...
{function h(b,c)
    {this.options=a.extend(!0,{},e,c),
                ...
                this.init()}
    var e={bounds:!0,country:null,map:!1,details:!1,detailsAttribute:"name",location:!1,
                mapOptions:{zoom:14,scrollwheel:!1,mapTypeId:"roadmap"},
                markerOptions:{draggable:!1},maxZoom:16,types:["geocode"]},
            f="street_address route intersection political country \n\
administrative_area_level_1 administrative_area_level_2 administrative_area_level_3 \n\
colloquial_area locality sublocality neighborhood premise subpremise postal_code \n\
natural_feature airport park point_of_interest post_box street_number floor room \n\
lat lng viewport location formatted_address location_type bounds".split(" "),
            g="id url website vicinity reference name rating international_phone_number \n\
icon formatted_phone_number".split(" ");
    ...
    {init:function()
        ...
        {if(!this.options.map)return;
            ...
            {this.map=this.options.map;
                return}
            this.map=new google.maps.Map(a(this.options.map)[0],
        ...
        {if(!this.map)return;
            ...
            this.marker=new google.maps.Marker(b),
                    google.maps.event.addListener(this.marker,"dragend",
            a.proxy(this.markerDragged,this))},
                initGeocoder:function()
        {var b={types:this.options.types,
                        bounds:this.options.bounds===!0?null:this.options.bounds,componentRestrictions:this.options.componentRestrictions};
            ...
            {if(a.keyCode===13)return!1}),
                    this.$input.bind("geocode",a.proxy(function(){this.find()},
            this))},
                initDetails:function()
        {function e(a){d[a]=b.find("["+c+"="+a+"]")}
        ...
        {var a=this.options.location,b;if(!a)return;
            if(typeof a=="string")
            {this.find(a);
                return}
            a instanceof Array&&(b=new google.maps.LatLng(a[0],a[1])),
                ...
                geocode:function(b)
        {this.options.bounds&&!b.bounds&&(this.options.bounds===!0?b.bounds=this.map&&this.map.getBounds():b.bounds=this.options.bounds),
        ...
        {if(b===google.maps.GeocoderStatus.OK)
            ...
            {var c={},
                ...
                {var d=b.types[0];c[d]=b.long_name,c[d+"_short"]=b.short_name}),
                ...
                {var d=c[a];this.setDetail(b,d)},
                this)),
                        this.data=c},
                    setDetail:function(a,b){b===d?b="":typeof b.toUrlValue=="function"&&(b=b.toUrlValue()),
        ...
        {var c="plugin_geocomplete";
            ...
            {var d=a(this).data(c)||a(this).geocomplete().data(c),e=d[b];
                return typeof e=="function"?(e.apply(d,Array.prototype.slice.call(arguments,1)),
                a(this)):(arguments.length==2&&(e=arguments[1]),e)}return this.each(function()
            {var d=a.data(this,c);d||(d=new h(this,b),a.data(this,c,d))}
        )}
