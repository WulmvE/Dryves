<%-- 
    Document   : SearchRideList
    Created on : 5-mei-2013, 20:24:44
    Author     : Vincent
--%>
...
<!-- tabs-->
		<div class="span9">
				<div class="tabbable"> <!-- Only required for left/right tabs -->
					...
					<li class="active"><a href="#tab1" data-toggle="tab">Zoek een rit</a></li>
	...
	<form class= "well span12">	
		...
		<div class="span2">
		<button class="btn btn-primary">Opnieuw zoeken</button>	
		</div>
	</form>
