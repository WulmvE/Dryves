<%-- 
    Document   : myRides
    Created on : 5-mei-2013, 20:35:48
    Author     : Vincent
--%>
                ...
                <div class="span9">
                    <div class="tabbable"> <!-- Only required for left/right tabs -->
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active"><a href="/Dryves/myRides" data-toggle="tab">Mijn aangeboden ritten</a></li>
